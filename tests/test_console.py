...
#         with patch("sys.stdout", new=StringIO()) as outputText:
#             self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
#             testID = outputText.getvalue().strip()
#         with patch("sys.stdout", new=StringIO()) as outputText:
#             obj = storage.all()["BaseModel.{}".format(testID)]
#             command = "show BaseModel {}".format(testID)
#             self.assertFalse(HBNBCommand().onecmd(command))
#             self.assertEqual(obj.__str__(), outputText.getvalue().strip())
#         with patch("sys.stdout", new=StringIO()) as outputText:
#             self.assertFalse(HBNBCommand().onecmd("create User"))
#             testID = outputText.getvalue().strip()
#         with patch("sys.stdout", new=StringIO()) as outputText:
...
#             self.assertIn("BaseModel", outputText.getvalue().strip())
#             self.assertIn("User", outputText.getvalue().strip())
#             self.assertIn("State", outputText.getvalue().strip())
#             self.assertIn("Place", outputText.getvalue().strip())
#             self.assertIn("City", outputText.getvalue().strip())
#             self.assertIn("Amenity", outputText.getvalue().strip())
#             self.assertIn("Review", outputText.getvalue().strip())
...
#             self.assertIn("BaseModel", outputText.getvalue().strip())
#             self.assertNotIn("User", outputText.getvalue().strip())
#         with patch("sys.stdout", new=StringIO()) as outputText:
#             self.assertFalse(HBNBCommand().onecmd("all User"))
#             self.assertIn("User", outputText.getvalue().strip())
#             self.assertNotIn("BaseModel", outputText.getvalue().strip())
#         with patch("sys.stdout", new=StringIO()) as outputText:
...
#             self.assertEqual("0", outputText.getvalue().strip())
...
#             self.assertEqual("1", outputText.getvalue().strip())
#         with patch("sys.stdout", new=StringIO()) as outputText:
#             self.assertFalse(HBNBCommand().onecmd("create User"))
#         with patch("sys.stdout", new=StringIO()) as outputText:
